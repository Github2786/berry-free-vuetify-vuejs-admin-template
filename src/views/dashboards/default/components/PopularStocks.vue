...
const usertype = ref();
onMounted(() => {
  name.value = JSON.parse(localStorage.getItem("user")).data.name;
  usertype.value = JSON.parse(localStorage.getItem("user")).data.usertype;
});
</script>
    ...
    <v-card variant="outlined">
      <v-card-text>
        <div class="d-flex align-center">
          <h4 class="text-h4 mt-1">My Leads</h4>
          <div class="ml-auto">
